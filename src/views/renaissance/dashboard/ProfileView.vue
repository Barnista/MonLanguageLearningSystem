<template>
    <div class="profile-view pb-5 custom-h-100" :style="{ backgroundColor: getAvatarById(currentUser?.photoURL).backgroundColor }">
        <div class="mt-3 mt-md-4 container">
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-9 col-xl-9">
                    <CompProfile class="rounded border shadow" :lang="lang" />
                </div>
            </div>
        </div>
    </div>
...
import CompProfile from '@/components/renaissance/dashboard/CompProfile.vue';
