...
import CompVowelTable from '@/components/based/alphabets/vowel/CompVowelTable.vue';
import CompOtherVowelTable from '@/components/based/alphabets/vowel/CompOtherVowelTable.vue';
