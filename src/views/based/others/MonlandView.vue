...
import CompMobileKeyboard from '@/components/based/keyboard/CompMobileKeyboard.vue';
import CompSimpleKeyboard from '@/components/based/keyboard/CompSimpleKeyboard.vue';
import CompMonland from '@/components/based/others/abouts/monland/CompMonland.vue';
