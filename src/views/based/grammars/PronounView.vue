...
import CompPronounTable from '@/components/based/grammars/pronoun/CompPronounTable.vue';
import CompGrammarJourney from '@/components/based/misc/CompGrammarJourney.vue';
