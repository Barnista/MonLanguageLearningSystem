                ...
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.neutral.singular.secondPerson" />
                    </td>
                    <td>
                         <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.neutral.plural.secondPerson" />
                    </td>
                </tr>
                <tr>
                    <th class="bg-formal">
                    ...
                    <td>
                         <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.formal.singular.secondPerson" />
                    </td>
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.formal.plural.secondPerson" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.informal.singular.secondPerson" />
                    </td>
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="pronounDailyUse.informal.plural.secondPerson" />
                    </td>
                </tr>
            </tbody>
        </table>
