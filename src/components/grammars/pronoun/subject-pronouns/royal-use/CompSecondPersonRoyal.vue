<template>
    <div class="comp-speaker-monk-pronoun-table">
        ...
        <p v-html="langSet[lang || 'en'].pronounView.secondPersonRoyalDescription">
        </p>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :pronouns="pronounRoyal.speakerToMonarch.singular.secondPerson"
                            :lang="lang" :lang-set="langSet" />
                    </td>
                    <td>
                        <CompPronounCard2 :pronouns="pronounRoyal.speakerToMonarch.plural.secondPerson"
                            :lang="lang" :lang-set="langSet" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :pronouns="pronounRoyal.monarchToSpeaker.singular.secondPerson"
                            :lang="lang" :lang-set="langSet" />
                    </td>
                    <td>
                        <CompPronounCard2 :pronouns="pronounRoyal.monarchToSpeaker.plural.secondPerson"
                            :lang="lang" :lang-set="langSet" />
                    </td>
                </tr>
            </tbody>
