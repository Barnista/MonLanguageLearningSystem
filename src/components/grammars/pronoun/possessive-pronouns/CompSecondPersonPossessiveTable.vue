<template>
    <div class="comp-first-person-pronoun-table">
        <h4>{{ langSet[lang || 'en'].pronounView.secondPersonPossessive }}</h4>
        <p v-html="langSet[lang || 'en'].pronounView.secondPersonPossessiveDescription">
        </p>
        <table>
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="possessive.neutral.singular.secondPerson" />
                    </td>
                    <td>
                         <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="possessive.neutral.plural.secondPerson" />
                    </td>
                </tr>
            </tbody>
        </table>
...
export default {
    ...
    data: () => ({
        ...
        possessive: dbPronouns.pronouns.possessive,
    })
}
</script>
