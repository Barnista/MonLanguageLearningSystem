<template>
    <div class="comp-first-person-pronoun-table">
        <h4>{{ langSet[lang ?? 'en'].pronounView.firstPersonPossessive }}</h4>
        <p v-html="langSet[lang ?? 'en'].pronounView.firstPersonPossessiveDescription">
        </p>
        <table>
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="possessive.neutral.singular.firstPerson" />
                    </td>
                    <td>
                         <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="possessive.neutral.plural.firstPerson" />
                    </td>
                </tr>
            </tbody>
        </table>
