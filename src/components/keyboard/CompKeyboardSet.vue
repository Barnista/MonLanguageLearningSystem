    ...
    <div class="keyboard-comp m-auto" style="max-width: 900px;">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="d-flex align-items-center">
                <span v-if="isCopied" class="text-success me-2">{{ langSet[lang ? lang : 'en'].keyboard.copyTxt
                }}</span>
        ...
        <p class="mt-3 text-center text-muted">
            <small>
                {{ langSet[lang ? lang : 'en'].keyboard.developedBy }} <a
                    href="https://github.com/Barnista/MonLanguageLearningSystem" target="_blank">Barnista</a>.
                {{ langSet[lang ? lang : 'en'].keyboard.poweredBy }} <a href="https://github.com/hodgef/simple-keyboard"
