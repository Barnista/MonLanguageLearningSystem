    ...
    data: () => ({
        ...
        layouts: {
            mon: {
                layout: {
                    'default': [
                        'ဆ တ န မ အ ပ က ၚ သ စ {bksp}',
                        'ေ ျ ိ ် ါ ဴ ြ ု ူ း ာ',
                        '{shift} ဖ ထ ခ လ ဘ ည ယ ဟ',
                        '{lock} ဍ ရ {space} ၊ ၞ {enter}'
                    ],
                    'shift': [
                        'ၛ ဝ ဣ ဒ ဓ ဂ ဥ ၎ ဿ ဏ {bksp}',
                        'ဗ ှ ီ ္ ွ ံ ဲ ၟ ဳ ၠ ဵ',
                        '{shift} ဇ ဌ ဃ ဠ ၜ ဉ ဋ ဨ',
                        '{lock} ဩ င {space} ။ ၚ်္ {enter}'
                    ],
                    'lock': [
