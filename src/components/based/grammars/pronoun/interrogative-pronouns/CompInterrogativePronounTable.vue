<template>
    <div class="comp-first-person-pronoun-table">
        <p v-html="langSet[lang || 'en'].pronounView.interrogativePronounDescription">
        </p>
        <table>
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <CompPronounCard2 :lang="lang" :lang-set="langSet"
                                :pronouns="interrogative.neutral" col="12" col-md="6" col-lg="4" />
                    </td>
                </tr>
            </tbody>
        </table>
...
export default {
    ...
    data: () => ({
        ...
        interrogative: dbPronouns.pronouns.interrogative,
    })
}
</script>
