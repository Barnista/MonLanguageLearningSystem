<template>
    <div id="double-consonant-table">
        <h2>{{ langSet[lang || 'en'].learnAlphabets.doubleConsonants }} (2)</h2>
        <p v-html="langSet[lang || 'en'].doubleConsonantView.description"></p>
        <div>
            <ol>
                <li v-html="langSet[lang || 'en'].doubleConsonantView.titleType1"></li>
                <li v-html="langSet[lang || 'en'].doubleConsonantView.titleType2"></li>
            </ol>
            <hr>
        </div>
        <div class="mt-4">
        ...
        <div class="mt-5">
            <h3 v-html="`1. ${langSet[lang || 'en'].doubleConsonantView.titleType1}`"></h3>
            <p v-html="langSet[lang || 'en'].doubleConsonantView.descriptionType1"></p>
            <table class="my-3">
                <thead>
                    <tr>
                        <td class="bg-light fw-bold">
                            <span v-html="langSet[lang || 'en'].table.doubleExample"></span>
                        </td>
                        <td class="bg-light fw-bold">
                            <span v-html="langSet[lang || 'en'].table.doubleFullWriting"></span>
                        </td>
                        <td class="bg-light fw-bold">
                            <span v-html="langSet[lang || 'en'].table.pronounciation"></span>
                        </td>
                        <td class="bg-light fw-bold">
                            <span v-html="langSet[lang || 'en'].table.pronounciationThai"></span>
                        </td>
                        <td class="bg-light fw-bold">
                            <span v-html="langSet[lang || 'en'].table.translationThai"></span>
                        </td>
                    </tr>
                </thead>
                <tbody>
            ...
            <p>
                <span class="fw-bold text-danger">{{ langSet[lang || 'en'].doubleConsonantView.note }}</span>
                <span class="fw-bold">{{ langSet[lang || 'en'].doubleConsonantView.noteType1 }}</span>
            </p>
            <hr>
        </div>
        <div class="mt-5">
            <h3 v-html="`2. ${langSet[lang || 'en'].doubleConsonantView.titleType2}`"></h3>
            <p v-html="langSet[lang || 'en'].doubleConsonantView.descriptionType2"></p>
            ...
            <div class="mb-3">
                <span v-html="langSet[lang || 'en'].doubleConsonantView.descriptionTable2"></span>
            </div>
                ...
                <div class="accordion-item">
                    <h1 class="accordion-header" id="headingConsonantTable">
                        <button class="fw-bold accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            {{ langSet[lang || 'en'].learnAlphabets.consonants }} (35)
                        </button>
                    </h1>
            ...
            <hr>
            <div class="mb-3">
                <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleType21"></span>
                <ol>
                    <li>
                        <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleType22"></span>
                    </li>
                    <li>
                        <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleType23"></span>
                    </li>
                </ol>
            </div>
            <div class="mb-3">
                <h4>{{ langSet[lang || 'en'].doubleConsonantView.ruleTitle2 }}</h4>
                <ol>
                    <li>
                        <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleNo21"></span>
                    </li>
                    <li>
                        <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleNo22"></span>
                    </li>
                    <li>
                        <span v-html="langSet[lang || 'en'].doubleConsonantView.ruleNo23"></span>
                    </li>
                </ol>
            </div>
            <div class="mb-3">
                <h4>{{ langSet[lang || 'en'].doubleConsonantView.titleTable2 }}</h4>
                <table class="my-3">
                    <thead>
                        <tr>
                            <td class="d-none bg-light fw-bold">
                                <span v-html="langSet[lang || 'en'].table.rowAt"></span>
                            </td>
                            <td class="bg-light fw-bold">
                                <span v-html="langSet[lang || 'en'].table.columnAt"></span>
                            </td>
                            <td class="bg-light fw-bold">
                                <span v-html="langSet[lang || 'en'].table.doubleAt"></span>
                            </td>
                            <td class="bg-light fw-bold">
                                <span v-html="langSet[lang || 'en'].table.doubleExample"></span>
                            </td>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in examplePaliSansakrit" :key="index">
                            ...
                            <td v-else class="fs-5 fst-italic text-muted">{{ langSet[lang || 'en'].table.none }}
                            </td>
