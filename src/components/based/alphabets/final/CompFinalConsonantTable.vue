<template>
    <div id="final-consonant-table">
        <h2>{{ langSet[lang || 'en'].learnAlphabets.finalConsonants }} (10)</h2>
        <p v-html="langSet[lang || 'en'].finalConsonantView.description"></p>
        <table>
            <thead>
                <tr>
                    <th>{{ langSet[lang || 'en'].table.no }}</th>
                    <th>{{ langSet[lang || 'en'].table.finalConsonant }}</th>
                    <th>{{ langSet[lang || 'en'].table.finalSymbol }}</th>
                    <th>{{ langSet[lang || 'en'].table.other }}</th>
                </tr>
            </thead>
            <tbody>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" :id="`accordionNo${index}`">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <h3 class="text-start">
                            {{ index + 1 }}. {{ langSet[lang || 'en'].finalConsonantView.group }}
