            ...
            <div class="col-12 col-lg-12 mb-3">
                <router-link :to="{ path: '/apps/dictionary', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].apps.dictionary || '_DICTIONARY_'
                            }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-lg-3 mb-3">
                <router-link :to="{ path: '/apps/text-analyser', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].apps.textAnalyser || '_TEXT_ANALYSER_'
                            }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-lg-3 mb-3">
                <router-link :to="{ path: '/keyboard', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].keyboard.title || '_KEYBOARD_'
                            }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-lg-3 mb-3">
                <router-link :to="{ path: '/apps/word-craft', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].apps.wordCraft || '_WORD_CRAFT_'
                            }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-lg-3 mb-3">
                <router-link :to="{ path: '/apps/num-converter', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].apps.numConverter || '_NUM_CONVERTER_'
                            }}</span>
                    </div>
                </router-link>
            </div>
