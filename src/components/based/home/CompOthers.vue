<template>
    <div id="comp-others">
        <h3 class="text-dark mb-4">{{ langSet[lang || 'en'].navbar.others || '_TITLE_' }} (တၞဟ်ခြာ)</h3>
        <div class="row">
            <div class="col-6 col-xl-3 mb-3">
                <router-link :to="{ path: '/community', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].navbar.community || '_COMMUNITY_'
                            }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-xl-3 mb-3">
                <router-link :to="{ path: '/abouts', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].navbar.abouts || '_ABOUTS_' }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-xl-3 mb-3">
                <router-link :to="{ path: '/about-dev', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].navbar.dev || '_DEVS_' }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-6 col-xl-3 mb-3">
                <router-link :to="{ path: '/report-issues', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].navbar.report || '_REPORT_' }}</span>
                    </div>
                </router-link>
            </div>
            <div class="col-12 col-xl-3 mb-3">
                <router-link :to="{ path: '/change-logs', query: { lang } }"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-center w-100 h-100">
                        ...
                        <span class="fs-5 fw-bold">{{ langSet[lang || 'en'].aboutView.changeLogs ||
                            '_CHANGE_LOGS_' }}</span>
                    </div>
                </router-link>
            </div>
