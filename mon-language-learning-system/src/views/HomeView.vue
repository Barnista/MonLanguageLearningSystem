<template>
  <div class="home container">
    <div class="text-center my-5">
      <h1 class="display-4 fw-bold mb-3">{{ langSet[lang].homeView.welcome }} {{ about.appName }}</h1>
      <p class="lead mb-4">
        <span v-html="langSet[lang].homeView.description"></span>
      </p>
      <!--<img src="@/assets/mon-script-banner.png" alt="Mon Script Banner" class="img-fluid rounded shadow-sm mb-4" style="max-width: 400px;">-->
    </div>
    <div class="row my-4">
      <h2 class="text-dark mb-4">{{ langSet[lang].learnAlphabets.title }} (အက္ခရ်မန်)</h2>
...
export default {
  ...
  methods: {
    rebuildPanels() {
      this.panels = [
        {
          title: this.langSet[this.lang].learnAlphabets.consonants,
          route: `/alphabets/consonant?lang=${this.lang}`,
          icon: 'bi bi-book-half'
        },
        {
          title: this.langSet[this.lang].learnAlphabets.vowels,
          route: `/alphabets/vowel?lang=${this.lang}`,
          icon: 'bi bi-book-half'
        },
        {
          title: this.langSet[this.lang].learnAlphabets.compoundConsonants,
